...
int main(void){
  ...
  if(BSP_Button1_Input() == 0){ // run TExaS if Button1 is pressed
    ...
    TExaS_Init(GRADER, 7157);   // initialize the Lab 5 grader
...
// Logic analyzer will run, but the Lab 5 doesn't really use the logic analyzer
  ...
  testbuildbuff("buf0");
  test = OS_File_Append(n, Buff);      // 0x00020000
  testbuildbuff("buf1");
  test = OS_File_Append(n, Buff);      // 0x00020200
  testbuildbuff("buf2");
  test = OS_File_Append(n, Buff);      // 0x00020400
  testbuildbuff("buf3");
  test = OS_File_Append(n, Buff);      // 0x00020600
  testbuildbuff("buf4");
  test = OS_File_Append(n, Buff);      // 0x00020800
  testbuildbuff("buf5");
  test = OS_File_Append(n, Buff);      // 0x00020A00
  testbuildbuff("buf6");
  test = OS_File_Append(n, Buff);      // 0x00020C00
  testbuildbuff("buf7");
  test = OS_File_Append(n, Buff);      // 0x00020E00
